#!/bin/bash
# SDiaReward 7B model training script
#
# Usage:
#   bash scripts/train_7b.sh
#
# Prerequisites:
#   - Set MODEL_NAME_OR_PATH to your Qwen2.5-Omni-7B checkpoint path
